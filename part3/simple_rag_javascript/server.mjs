...
app.post("/", async (request, response) => {
  ...
  const prompt = PromptTemplate.fromTemplate(
    "Provide a detailed answer to the question using only the " + 
    "following support article:\n\n{context}\n\n" +
    "Question: {question}"
  );
  ...
  const result = await setupAndRetrieval.invoke(question)
  console.log('Prompt:\n\n')
  console.log(await prompt.invoke(result))
